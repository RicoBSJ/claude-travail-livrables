...
- **🔗 Pont** · [[2026-09-19_lecon-placement-financier_15_biais-comportementaux-epargnant]]
  **la règle C1 du parcours placement, écrite hier** — *une justification qui nomme un autre mécanisme que la réponse, c'est deux réponses* — vaut ici mot pour mot : le tableau dit « 1 action = 1 tâche », le corrigé compte une tâche par vente. Le prompt revenus-passifs n'a pas de C1
